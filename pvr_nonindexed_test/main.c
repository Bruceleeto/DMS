...
int main(int argc, char **argv) {
    ...
    const float BASE_Z = 18.0f;  // Distance from camera (increased to fit all balls)
    ...
    printf("Using programmatic balls: %d triangles per ball, %d total triangles for benchmark\n", 
           triangles_per_ball, benchmark_triangles);
